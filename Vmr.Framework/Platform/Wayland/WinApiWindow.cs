...
namespace Vmr.Framework.Platform.Wayland;

internal sealed class WaylandWindow : IPlatformWindow
{
    private readonly WaylandWindowSafeHandle _handle = new();

    private bool _disposed;

    ~WaylandWindow() => Dispose(disposing: false);

    public WaylandWindow(string title, Rectangle<int> bounds, bool fullScreen)
    {
        Title = title;
        Bounds = bounds;
